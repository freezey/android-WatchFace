 ...
 */
package com.freezey.android.wearable.freezeyface.model;
...
import com.freezey.android.wearable.freezeyface.config.ColorSelectionActivity;
import com.freezey.android.wearable.freezeyface.config.FreezeyfaceComplicationConfigActivity;
 ...
 * {@link FreezeyWatchFaceService} watch face's appearance and complications
 * via {@link FreezeyfaceComplicationConfigActivity}.
 */
public class AnalogComplicationConfigData {
    ...
    public static Class getWatchFaceServiceClass() {
        return FreezeyWatchFaceService.class;
    }
     ...
     * {@link ViewHolder} types in {@link FreezeyfaceComplicationConfigRecyclerViewAdapter}.
     */
    ...
    public static class PreviewAndComplicationsConfigItem implements ConfigItemType {
        ...
        public int getConfigType() {
            return FreezeyfaceComplicationConfigRecyclerViewAdapter.TYPE_PREVIEW_AND_COMPLICATIONS_CONFIG;
        }
    }
    ...
    public static class MoreOptionsConfigItem implements ConfigItemType {
        ...
        @Override
        public int getConfigType() {
            return FreezeyfaceComplicationConfigRecyclerViewAdapter.TYPE_MORE_OPTIONS;
        }
    }
    ...
    public static class ColorConfigItem  implements ConfigItemType {
        ...
        @Override
        public int getConfigType() {
            return FreezeyfaceComplicationConfigRecyclerViewAdapter.TYPE_COLOR_CONFIG;
        }
    }
    ...
    public static class UnreadNotificationConfigItem  implements ConfigItemType {
        ...
        @Override
        public int getConfigType() {
            return FreezeyfaceComplicationConfigRecyclerViewAdapter.TYPE_UNREAD_NOTIFICATION_CONFIG;
        }
    }
    ...
    public static class BackgroundComplicationConfigItem  implements ConfigItemType {
        ...
        @Override
        public int getConfigType() {
            return FreezeyfaceComplicationConfigRecyclerViewAdapter.TYPE_BACKGROUND_COMPLICATION_IMAGE_CONFIG;
        }
    }
}